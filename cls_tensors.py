...
class Tensors():
    ...
    def invariant(self):
        ...
        return det, trace 
    # rajouter les invariants du tenseur, redéfinir la méthode pour séparer 
    #les invariants
...
class StrainTensor(Tensors):
    ...
    def ehencky(self):
        ...
        [1] Hencky, H. (1928). "Über die Form des Elastizitätsgesetzes 
        bei ideal elastischen Stoffen". 
        Zeitschrift für technische Physik. 9: 215–220
        '''
